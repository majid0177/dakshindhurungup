        ...
        <div class="row">
          <div class="col-sm-6">
              ...
              <select name="surname" id="status" class="form-control">
                ...
                <option value="গ্রাম পুলিশ"  >গ্রাম পুলিশ</option>
            ...
            <div class="col-sm-6">
             ...
             <div class="form-group mt-5">
                 @if($staffs->pic==null || $staffs->pic=="")
                <img height="150" src="{{ asset('backend/staff/empty.jpg')  }}" />
                @else
                <img height="150" src="{{ asset('backend/staff/'.$staffs->pic)  }}" />
                @endif
