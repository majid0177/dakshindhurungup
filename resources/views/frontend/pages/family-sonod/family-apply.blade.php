...
<main id="tg-main" class="tg-main tg-haslayout">
			<div class="container">
				<div class="row">
                <div class="col-md-12">
                    <form action="https://amragachiaup.com/includes/family_sonod_insert_code.php" method="post">
						<input type="hidden" name="date" class="form-control" value="2024-04-01">
							<div class="card-box">
							<div class="row">
								<div class="col-sm-7">
									<h4 class="page-title txalc">পারিবারিক সনদের আবেদন</h4>
								</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<h4 class="ttle">আবেদনকারীর তথ্য </h4>
								</div>
