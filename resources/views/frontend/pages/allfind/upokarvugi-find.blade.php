                    ...
                    <div class="tg-content">
                        <div class="tg-jobs">
                            <div class="tg-heading">
                                <h2> জাতীয় পরিচয় পত্রের নম্বর দিয়ে আপনার তথ্য যাচাই করুন </h2>
                                <div class="tg-widget">
                                
                                    <div class="tg-widgetcontent">
                                        <form action="{{route('HoldingFindFromFrontend')}}" method="GET" class="tg-formtheme tg-formsearch" enctype="multipart/form-data">
                                            <fieldset>
                                                <input type="text" name="nid" value="{{ !empty($sodosso) ? $sodosso->nid : '' }}" class="form-control" required placeholder=" TYPE YOUR NID NUMBER  ">
                            ...
                            <div class="tg-themetabs tg-coursestabs">
                                <div class="tab-content tg-themetabcontent">
                                     ...
                                     @else 
                                     <div class="mrms">  জাতীয় পরিচয় পত্রের সঠিক নম্বর প্রদান করে আপনার তথ্য যাচাই করুন ।    </div>
                                     @endif
